            <section>
                ...
                ?>
                    <div class="form-group">
                        <label for="categorias">Selecione a categoria desejada:</label>
                        <select name="categorias" class="form-control" required>
                            <option value="*">Buscar por todas</option>
                    ...
                    <div class="form-group">
                        <label for="subcategorias">Selecione a subcategoria desejada (opcional)</label>
